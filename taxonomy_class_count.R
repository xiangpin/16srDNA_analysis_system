...
docstring = "Description:\\n The script is designed to caculate the different class level count.\\n Developer: Shuangbin Xu\\n Email: xusbin@anjiemed.com"
...
myparser$add_argument("-o", "--data", default="taxoutput_data.txt", help="the output data, default is taxoutput_data.txt.")
